...
const allowedDataMethods = new Set(["data.get", "data.put", "data.delete", "data.list", "data.migrate", "data.migrateBatch", "data.migrations"]);
...
const allowedMediaSourceMethods = new Set(["mediaSource.list", "mediaSource.stat", "mediaSource.probe", "mediaSource.createPlayback", "mediaSource.read"]);
