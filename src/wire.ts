...
const allowedPrefixes = ["broker.", "worker.", "lifecycle.", "context.", "capability.", "jobs.", "history.", "catalog.", "display.", "notifications.", "gateway.", "event.", "health.", "diagnostics.", "media.", "network.", "$/cancelRequest"];
...
const allowedMediaMethods = new Set(["media.createPlayback", "media.probe", "media.transform", "media.read", "media.readOutput", "media.list"]);
